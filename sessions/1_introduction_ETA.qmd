...
**History of ETA**
 ...
 + Has been instrumental to develop another methodological framework to identify, characterize and compare **Ecological Dynamic Regimes (EDR)** (Sánchez-Pinillos et al. 2023).
 
 + The framework has also been applied in a **paleoecological context** using elemental composition data (de la Casa et al. 2025).

 + Recently, the framework has been extended to cyclical data (Djeghri et al. 2026), under the name of **Cyclical Ecological Trajectory Analysis (CETA)**.
