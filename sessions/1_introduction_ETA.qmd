...
Ecological Trajectory Analysis (ETA) is a framework to analyze the dynamics of ecological entities (e.g. individuals, communities or ecosystems) in a chosen multivariate space.
...
**Brief history of ETA**
 ...
 + Extended to cyclical data, under the name of **Cyclical Ecological Trajectory Analysis (CETA)** ([Djeghri et al. 2026](https://doi.org/10.1002/ecm.70058)).
