...
**Brief history of ETA**
 ...
 + Introduced as **Community Trajectory Analysis (CTA)**, a framework for trajectory analysis in community ecology ([De Cáceres et al. 2019](https://doi.org/10.1002/ecm.1350)).

 + Extended with new **metrics** and **visualisation** modes ([Sturbois et al. 2021a](https://doi.org/10.1016/j.ecolmodel.2020.109400)).

 + Applied to stable isotope data, referred to it as **Stable Isotope Trajectory Analysis (SITA)** ([Sturbois et al. 2021b](https://doi.org/10.1002/ecm.1501)).
 
 + Instrumental to develop another methodological framework: **Ecological Dynamic Regimes (EDR)** ([Sánchez-Pinillos et al. 2023](https://doi.org/10.1002/ecm.1589)).

 + Instrumental to develop another methodological framework: **Ecological Quality Assessment (EQA)** ([Sturbois  et al. 2023](https://doi.org/10.1002/ecs2.4726)).
 
 + Applied in a **paleoecological context** using elemental composition data ([de la Casa et al. 2025](https://doi.org/10.1016/j.ecolind.2025.113630)).

 + Extended to cyclical data, under the name of **Cyclical Ecological Trajectory Analysis (CETA)** (Djeghri et al. 2026)^[Djeghri N, Sturbois A, Hélaouët P, Geissmann Q, Rimmelin-Maury P, Boyé A, Gauthier O, De Cáceres M (2026). Going round in cycles but going somewhere: Deciphering cyclical dynamics using Ecological Trajectory Analysis. Ecological Monographs.].
...
## Diversity of target entities and multivariate spaces

The ETA framework has been applied to different contexts, using different kinds of descriptors to define the multivariate space:

| Context   | Multivariate space ($\Omega_0$) | References                                                  |
|-------------------|--|---------------------------------------------------|
| Community ecology | Species composition | [Tuomi et al. (2023)](https://doi.org/10.1111/ecog.06489), [Hopper et al. (2024)](https://doi.org/10.1111/1365-2656.14046), [Lécuyer et al. (2024)](https://doi.org/10.1016/j.ecss.2024.108738), [Hoffman et al. (2025)](https://doi.org/10.1111/ele.70033) |
| Soil biology | DNA based OTU composition | [Hacopian et al (2024)](https://doi.org/10.1016/j.soilbio.2024.109511), [Barnett et al. (2024)](https://doi.org/10.1111/ele.14393), [Meyneng et al. (2024)](https://doi.org/10.1186/s40793-024-00554-9) |
| Conservation biology | Species composition, DNA based OTU composition | [Sturbois et al. (2021)](https://doi.org/10.1002/aqc.3704), [Neely et al. (2023)](https://doi.org/10.1038/s42003-023-05600-9),  [Joyce et al. (2024)](https://doi.org/10.1016/j.biocon.2024.110593), [Scotti et al. (2024)](https://doi.org/10.1002/rra.4393) |
| Functional ecology | Functional traits, chemical composition,  isotopic composition | [Sturbois et al (2021)](https://doi.org/10.1002/ecm.1501), [Darragh et al. (2023)](https://doi.org/10.1111/jeb.14165), [Coulon et al. (2024)](https://doi.org/10.1016/j.marenvres.2024.106531) |
| Forest ecology | Diameter distribution, structural metrics from LiDAR, species composition | [De Cáceres et al. (2019)](https://doi.org/10.1002/ecm.1350), [Davies et al. (2023)](https://doi.org/10.1002/ece3.9912), [Walesiak et al. (2024)](https://doi.org/10.1111/1365-2664.14727), [Kikuchi et al. (2024)](https://doi.org/10.1016/j.foreco.2024.122182), [Vogel et al. (2024)](https://doi.org/10.3390/grasses3030015) | 
| Paleoecology | Fossil taxa composition, elemental composition, fossil pollen composition| [Staples et al. (2024)](https://doi.org/10.1111/geb.13787), [de la Casa et al. (2025)](https://doi.org/10.1016/j.ecolind.2025.113630) |
| Plant or animal pathology | Pathogen/parasite composition, DNA-based OTU composition | [VanWallendael et al. (2022)](https://doi.org/10.1371/journal.pbio.3001681), [Bakker et al. (2023)](https://doi.org/10.3389/fmicb.2023.1271219), [Mathieu-Begné et al. (2023)](https://doi.org/10.1111/mec.16901)  |
...
| *Angle with respect to the initial segment*  | The angle between the initial segment and the vector joining the initial state and current state. |
| *Angle with respect to 2D axes* | The angle between a particular segment and the first or second axis. | 
| *Trajectory directionality* | A measure of trajectory straightness. Calculated as the weighed average of along the trajectory of the relative difference between angles and straight lines (180º). |
:::
...
| Angle with respect to the initial segment  | *Does the trajectory continue the initial direction?* |
...
We see that the observations of trajectory "2" correspond to states of trajectory "1" at 0.5 time units later in time. Surveys with missing values (e.g. `NA`) indicate that the projection of the target state cannot be determined (because the reference trajectory is too short).
...
# 8. Transforming trajectories {background-color="#008080"}
...
# 9. Advantages and limitations {background-color="#008080"}

## Advantages and limitations

![](resources/img/logo_ecotraj.png){.absolute width="100" bottom="30"}
...
+ *Great flexibility* regarding target entities, sampling design and multivariate state space.

+ Ability to compare ecological dynamics *globally*.

+ Can be *combined* with other frameworks (including second-order trajectory analysis).
...
+ Primarily *descriptive* (although includes some inferential tests).

+ Computationally *inefficient* for very large data sets (at present).

+ Metrics are affected by *sampling design*, i.e. the frequency of surveys and size of sampling units.
